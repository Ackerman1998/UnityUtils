...
public class RectGuidance : MonoBehaviour
{
    ...
    public void Init(RectTransform target,bool GuidePanel=false)
    {
        this.target = target;
        ...
        Canvas canvas;
         ...
         canvas = GameObject.Find("GuidePanel").GetComponent<Canvas>();
    ...
    public void Init(Image target, Canvas can, bool GuidePanel=false)
    {
        Init(target.rectTransform, GuidePanel);
    }
    /// <summary>
    /// 收缩速度
    /// </summary>
